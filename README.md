# `mccabe-thiele` Toolbox for GNU-Octave
...
![Illustrative graphical output](https://github.com/aumpierre-unb/McCabe-Thiele-for-GNU-Octave/blob/main/pics/updown_satliq.png "Example of graphical output - from y=f(x) function and saturated liquid feed, stages from top to bottom")
...
https://zenodo.org/account/settings/github/repository/aumpierre-unb/McCabe-Thiele-for-GNU-Octave.
