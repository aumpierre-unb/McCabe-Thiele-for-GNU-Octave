...
![Illustrative graphical output](https://github.com/aumpierre-unb/McCabe-Thiele-for-GNU-Octave/blob/main/pics/downup_matrix.png "Example of graphic output - from x-y data set, stages from bottom to top")
